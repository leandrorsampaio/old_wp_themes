...
$cssImgBorderZeroV1 = 'style="border:0; width: 290px; height: 200px;"';
$cssImgBorderZerov2 = 'style="border:0; width: 190px; height: 130px;"';
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style=" width: 290px; background-color: #fff;">
                                                                    <a style="<?php echo $cssNoUnderline . $cssNoBorder; ?>" href="<?php the_field('newsletter_destaque1_link'); ?>" target="_blank">
                                                                        <img src="<?php the_field('newsletter_destaque1_img'); ?>" alt="<?php the_field('newsletter_destaque1_titulo'); ?>" <?php echo $cssImgBorderZeroV1; ?> />
                                                                    </a>
                                                                ...
                                                                <td style=" width: 290px; background-color: #fff;">
                                                                    <a style="<?php echo $cssNoUnderline . $cssNoBorder; ?>" href="<?php the_field('newsletter_destaque2_link'); ?>" target="_blank">
                                                                        <img src="<?php the_field('newsletter_destaque2_img'); ?>" alt="<?php the_field('newsletter_destaque2_titulo'); ?>" <?php echo $cssImgBorderZeroV1; ?> />
                                                                    </a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style=" width: 190px; background-color: #fff;">
                                                                    <a style="<?php echo $cssNoUnderline . $cssNoBorder; ?>" href="<?php the_field('newsletter_destaque3_link'); ?>" target="_blank">
                                                                        <img src="<?php the_field('newsletter_destaque3_img'); ?>" alt="<?php the_field('newsletter_destaque3_titulo'); ?>" <?php echo $cssImgBorderZeroV2; ?> />
                                                                    </a>
                                                                ...
                                                                <td style=" width: 190px; background-color: #fff;">
                                                                    <a style="<?php echo $cssNoUnderline . $cssNoBorder; ?>" href="<?php the_field('newsletter_destaque4_link'); ?>" target="_blank">
                                                                        <img src="<?php the_field('newsletter_destaque4_img'); ?>" alt="<?php the_field('newsletter_destaque4_titulo'); ?>" <?php echo $cssImgBorderZeroV2; ?> />
                                                                    </a>
                                                                ...
                                                                <td style=" width: 190px; background-color: #fff;">
                                                                    <a style="<?php echo $cssNoUnderline . $cssNoBorder; ?>" href="<?php the_field('newsletter_destaque5_link'); ?>" target="_blank">
                                                                        <img src="<?php the_field('newsletter_destaque5_img'); ?>" alt="<?php the_field('newsletter_destaque5_titulo'); ?>" <?php echo $cssImgBorderZeroV2; ?> />
                                                                    </a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style=" width: 190px; background-color: #fff;">
                                                                    <a style="<?php echo $cssNoUnderline . $cssNoBorder; ?>" href="<?php the_field('newsletter_parceiro1_link'); ?>" target="_blank">
                                                                        <img src="<?php the_field('newsletter_parceiro1_imagem'); ?>" alt="<?php the_field('newsletter_parceiro1_nome'); ?>" <?php echo $cssImgBorderZeroV2; ?> />
                                                                    </a>
                                                                ...
                                                                <td style=" width: 190px; background-color: #fff;">
                                                                    <a style="<?php echo $cssNoUnderline . $cssNoBorder; ?>" href="<?php the_field('newsletter_parceiro2_link'); ?>" target="_blank">
                                                                        <img src="<?php the_field('newsletter_parceiro2_imagem'); ?>" alt="<?php the_field('newsletter_parceiro2_nome'); ?>" <?php echo $cssImgBorderZeroV2; ?> />
                                                                    </a>
                                                                ...
                                                                <td style=" width: 190px; background-color: #fff;">
                                                                    <a style="<?php echo $cssNoUnderline . $cssNoBorder; ?>" href="<?php the_field('newsletter_parceiro3_link'); ?>" target="_blank">
                                                                        <img src="<?php the_field('newsletter_parceiro3_imagem'); ?>" alt="<?php the_field('newsletter_parceiro3_nome'); ?>" <?php echo $cssImgBorderZeroV2; ?> />
                                                                    </a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 280px;">
                                                                        <a href="http://www.cidadedesaopaulo.com/sp/br/cadastrese" target="_blank" 
                                                                           style="width: 100%; display: block; text-decoration: none; <?php echo $cssTitlepadrao2; ?>">
                                                                            Receba nossa news
                                                                        </a>
                                                                    </td>
                                                                    <td style="width: 180px;"></td>
                                        ...
                                        <table <?php echo $padraoTable; ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php echo $separadorTdBig; ?>
                                                    <td style="width: 200px; font-size: 9px; margin-top: 0; margin-bottom: 0; <?php echo $cssAlinhaDireita . $cssFonte . $cssNoUnderline . $cssPreto . $cssMargemTexto; ?>">
                                                        <span style="text-align:center; margin: 0 auto;"><?php the_field('newsletter_expediente'); ?></span>
                                                    </td>
                                                    <?php echo $separadorTdBig; ?>
                                                </tr>
                                                <tr>
