...
<div id="all_content">
    ...
    <div id="content">
        ...
        <div id="content_bloco3_">
            ...
            <div class="content_bloco2_box360">
                <a href="http://www.spturis.com/anhembi/360/" target="_blank"><img src="<?php bloginfo('template_url') ?>/images/banner_360_home.png" border="0"  /></a>
            </div>
        </div>
        <!------------------------------------------ BLOCO 4 ---------------------------------->
        <div id="content_bloco3__">
            ...
            <div class="content_bloco4_boxServico">
                <a href="http://www.anhembi.com.br/servicos/telecom/">
            ...
            <div class="content_bloco4_boxServico">
                <a href="http://www.anhembi.com.br/servicos/encontre-aqui/">
                    <img src="<?php bloginfo('url') ?>/wp-content/uploads/icone_encontrei.png" border="0" title="Localize-se" />
                    <div class="content_bloco4_boxServico_title">
