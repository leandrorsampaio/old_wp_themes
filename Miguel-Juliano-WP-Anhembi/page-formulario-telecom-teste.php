        ...
        <div id="content_direita">
            ...
            <div id="contato">
                ...
                <body style="background: #fff">
                    ...
                    <form action="<?php echo get_template_directory_uri(); ?>/grava_form.php" name="telecomForm" method="post" onsubmit="return validaForm()" >
                        ...
                        <div id="telecomForm_servicos_bloco2" class="servicos_bloco">
                            ...
                            <div class="telecomForm_servicosItem">
                                ...
                                <span id="telefonia_cod60_Qtd">
                                    ...
                                    <input type="hidden" name="sessenta" id="sessenta" value="60" />
