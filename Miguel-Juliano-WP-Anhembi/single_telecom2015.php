    ...
    <div id="contentIntern">
        ...
        <div id="content_breadcrumb">
            <h4 id="content_breadcrumb_text">
                ...
                - 
                <a href="<?php echo get_permalink(11339); ?>">
                    <?php
                    $post_id = 11339;
                    $queried_post = get_post($post_id);
                    $title = $queried_post->post_title;
        ...
        <div id="content_direita">
            ...
            if (is_single(11339)) {
                ...
                <div class="tl2015_wrapper">
                    <div id="tabs-container">
                        <p id="texto_pedido"> VEJA NOSSOS SERVI&Ccedil;OS: <div class="pontilhadoHOME"></div> <br /><br /></p>
                            ...
                            <div id="tab-1" class="tab-content">
                                ...
                                <div class="tl2015_linha tl2015_linhaMargem">
                                    <div class="itemEsqTRANSVIDEO">
                                        ...
                                        <i class="fa fa-exclamation-triangle awesomeIconesTelecom"></i>
                                        <img src="<?php bloginfo('template_url') ?>/images/questionmark.png" class="tooltip tl2015_imgNAVBAS_exclam" title="Uso n&atilde;o recomendado pelo Anhembi." />
                                    </div>
                                    <div class="itemCent">
                                ...
                                <div class="tl2015_linha tl2015_linhaMargem">
                                    ...
                                    <div class="itemDirTRANSAUDIO">
                                        ...
                                        <i class="fa fa-check-square-o awesomeIconesTelecom"></i>
                                    </div>
                                </div>
                                <div class="tl2015_linha tl2015_linhaMargem">
                                    <div class="itemEsq">
                                    ...
                                    <div class="itemCent">
                                        ...
                                        <form name="diarias">
                                            <select id="diarias_select" class="select_borda" onclick="contaTabelaTelefonia()">
                                                <option value="1">1 di&aacute;ria</option>
                                                <option value="2">2 di&aacute;rias</option>
                                                <option value="3">3 di&aacute;rias</option>
                                                <option value="4">4 di&aacute;rias</option>
                                                <option value="5">5 di&aacute;rias</option>
                                                <option value="6">6 di&aacute;rias</option>
                                                <option value="7">7 di&aacute;rias</option>
                                                <option value="8">8 di&aacute;rias</option>
                                                <option value="9">9 di&aacute;rias</option>
                                                <option value="10">10 di&aacute;rias</option>
                                                <option value="11">11 di&aacute;rias</option>
                                                <option value="12">12 di&aacute;rias</option>
                                                <option value="13">13 di&aacute;rias</option>
                                                <option value="14">14 di&aacute;rias</option>
                                                <option value="15">15 di&aacute;rias</option>
                                                <option value="16">16 di&aacute;rias</option>
                                                <option value="17">17 di&aacute;rias</option>
                                                <option value="18">18 di&aacute;rias</option>
                                                <option value="19">19 di&aacute;rias</option>
                                                <option value="20">20 di&aacute;rias</option>                                            
                                            </select>
                                        </form>
                                        </p>
                                    </div>
                                ...
                                <div class="tl2015_linha tl2015_linhaMargem">
                                    <div class="pagamentoLine">
                                        ...
                                        <p class="boleto_obs">*A forma de pagamento via boleto estar&aacute; dispon&iacute;vel at&eacute; oito (08) dias antes da realiza&ccedil;&atilde;o do seu evento.</p>
                                        </p>
                                    </div>
                                </div>
                            </div><!--TAB1-->                 
                            ...
                            <table class="tl2015_tabelatelefonia tl2015_tabelaGeral">
                                ...
                                <tr  class="tl2015_tr">
                                    <td class="tl2015_td tabelaGeral_alinhaLeft">
                                        <img src="<?php bloginfo('template_url') ?>/images/questionmark.png" class="tooltip tl2015_imgTABELA" title="Sistema PABX com tecnologia DDR (Discagem Direta a Ramais) que proporciona
                                             o recebimento de liga&ccedil;&otilde;es externas diretamente no seu ramal.  Os ramais ser&atilde;o do tipo anal&oacute;gicos.
                                             As tarifa&ccedil;&otilde;es destes ramais s&atilde;o registradas e cobradas ap&oacute;s o evento." />
                                    ...
                                    <td class="tabelatitulo tl2015_td" >
                                        ...
                                        <form name="diarias3">
                                            <select id="diarias_select3" onclick="contaTabelaTelefonia3()">
                                                <option value="1" class="option">1 di&aacute;ria</option>
                                                <option value="2" class="option">2 di&aacute;rias</option>
                                                <option value="3" class="option">3 di&aacute;rias</option>
                                                <option value="4" class="option">4 di&aacute;rias</option>
                                                <option value="5" class="option">5 di&aacute;rias</option>
                                                <option value="6" class="option">6 di&aacute;rias</option>
                                                <option value="7" class="option">7 di&aacute;rias</option>
                                                <option value="8" class="option">8 di&aacute;rias</option>
                                                <option value="9" class="option">9 di&aacute;rias</option>
                                                <option value="10" class="option">10 di&aacute;rias</option>
                                                <option value="11" class="option">11 di&aacute;rias</option>
                                                <option value="12" class="option">12 di&aacute;rias</option>
                                                <option value="13" class="option">13 di&aacute;rias</option>
                                                <option value="14" class="option">14 di&aacute;rias</option>
                                                <option value="15" class="option">15 di&aacute;rias</option>
                                                <option value="16" class="option">16 di&aacute;rias</option>
                                                <option value="17" class="option">17 di&aacute;rias</option>
                                                <option value="18" class="option">18 di&aacute;rias</option>
                                                <option value="19" class="option">19 di&aacute;rias</option>
                                                <option value="20" class="option">20 di&aacute;rias</option>      
                                            </select>
                                        </form>
                                    </td>
                                </tr>
                    ...
                    <div id="conteudo_pedido">
                        ...
                        <div class="pontilhadoMENOR">
                            ...
                            <div id="pedido4">
                                ...
                                <p class="texto">Ap&oacute;s a aprova&ccedil;&atilde;o da sua solicita&ccedil;&atilde;o, ser&aacute; encaminhado um email com Termo de Acordo de Servi&ccedil;o e Anexo II-Or&ccedil;amento,  contendo prazos, condi&ccedil;&otilde;es de pagamento e instru&ccedil;&otilde;es para finalizar a sua contrata&ccedil;&atilde;o.</p>
                                <br />
                            </div>    
                            <div id="pedido5">
                                <img src="<?php bloginfo('template_url') ?>/images/pedido_5.png" class="tl2015pedido_img"/>
                                <p class="texto texto_pedido5">Ao inserir o c&oacute;digo identificador do seu pedido no campo direcionado pelo link informado do email que encaminharmos, voc&ecirc; estar&aacute; na tela de pagamento do seu servi&ccedil;o. O pagamento poder&aacute; ser feito, em parcela &uacute;nica, por meio de boleto banc&aacute;rio ou cart&atilde;o de cr&eacute;dito, respeitando-se as datas de vencimento que estar&atilde;o informadas no Anexo II-Or&ccedil;amento.</p>
                            </div>
                            <div id="pedido6">
            ...
            if (is_single(11381)) {
                ?> 
                <div id="conteudo_pedido" style="width: 940px;">
                    <p id="texto_pedido"> CONSULTA </p>
                    <a class="botoesPadrao botaoDIREITA" target="_blank" href="<?php echo get_permalink(11339); ?>" style="float: right; width: 215px;">
                        TABELA DE SERVI&Ccedil;OS E PRE&Ccedil;OS
                    </a>        
                    <div class="pontilhado"></div>

                    <iframe style="overflow: auto; margin: 25px 0 0 0;" src="http://pagamentos.anhembi.com.br" width="940" height="900px" scrolling="no"></iframe>
            ...
            if (is_single(11379)) {
                ...
                <div id="conteudo_pedido">
                    <br />
                    <iframe src="http://anhembi.com.br/telecom/formulario/formulariob.php" width="690px" height="1100px" scrolling="no"></iframe>
                    <div class="botaoComoFunciona">
