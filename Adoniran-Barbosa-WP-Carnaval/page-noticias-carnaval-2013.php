        ...
        <div id="noticias_section">
            ...
            <div id="noticias_section_conteudo">
                ...
                <ul>
                    <?php
                    //---------------------------------- Query Lei Mais
                    $box1 = new WP_Query('posts_per_page=-1&anocarnaval=2013&post_type=post');
            ...
            <div id="noticias_section_outroscarnavais">
                <h4 class="red">Not&iacute;cias de outros carnavais:  <a href="http://carnaval.spturis.com.br/noticias-carnaval-2013/">2013</a>, <a href="http://carnaval.spturis.com.br/noticias/">2014</a> e <a href="http://carnaval.spturis.com.br/noticias-carnaval-2015/">2015</a></h4>
            </div>
            <?php
