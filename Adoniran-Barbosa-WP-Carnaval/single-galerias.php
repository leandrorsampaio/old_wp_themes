...
while (have_posts()): the_post();
        ...
        <section id="pictureka_section">
            ...
            <div id="pictureka_section_slider">
                <div id="pictureka_section_slider_wrap">
                    <?php
                    //---------------------------------- Query Galerias
                    $iddopost = get_field('galeria_single');
                    $box1 = new WP_Query('post_type=galerias&p=' . $iddopost);
                    while ($box1->have_posts()) : $box1->the_post();
                        ?>
                        <div id="pictureka_section_slider_wrap_big">
                            <?php
                            $images = get_posts(array("post_type" => "attachment", "post_parent" => $iddopost, "posts_per_page" => -1));
                            $contador = 1;
                        ...
                        <div id="pictureka_section_slider_wrap_thumbs">
                            ...
                            foreach ($images as $image) {
                                $urls = array();
                                list ($url) = wp_get_attachment_image_src($image->ID);
                                ?>
                                <a href="javascript: changeImage(<?php echo $contador; ?>);">
    ...
    <div id="maisGalerias">
        ...
        <div id="maisGalerias_lista">
            <?php
            //---------------------------------- Query Escolas
            $asideposts = new WP_Query('post_type=escolas&posts_per_page=32&orderby=rand');
            while ($asideposts->have_posts()) : $asideposts->the_post();
                ?>
                <div class="asideBox-maisEscolas_bandeira correcaoBandeiras2015">
