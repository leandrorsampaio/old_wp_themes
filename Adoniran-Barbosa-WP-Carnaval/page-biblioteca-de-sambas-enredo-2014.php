        ...
        <div id="noticias_section-biliotecaSampa">
            ...
            <div id="noticias_section_conteudo">
                <div id="page_section_conteudo">
                    ...
                    ?>
                    <a href="<?php echo get_permalink(4335); ?>" style="font-size: 1.2em; font-size: 1.2em; width: 100%; display: block; float: left; margin: 40px 0px 30px;">Veja a biblioteca de sambas-enredo de 2015</a>
