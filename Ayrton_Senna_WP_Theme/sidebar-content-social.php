<?php
if (is_page() || is_singular('espacos')) {
    
} else {
    ?>
    <div id="contentInterna_miolo_serviceBar_share">
        <div id="contentInterna_miolo_serviceBar_share_face">
            <div id="fb-root"></div>
        ...
        <div id="contentInterna_miolo_serviceBar_share_twitter">
