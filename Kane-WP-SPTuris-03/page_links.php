...
<div id="contentSingle">
    <div id="content_faixa">
        <div id="content_faixa_bread">
            <p id="content_faixa_bread_txt">Voc&ecirc; est&aacute; em: <a href="<?php bloginfo('url') ?>"><?php bloginfo('name') ?></a> > <span id="content_faixa_bread_txt2">Links</span></p>
        </div>
    ...
    <div id="contentSingle_colEsquerda">
        <h1 id="contentSingle_colEsquerda_tituloContato">Links</h1> 
