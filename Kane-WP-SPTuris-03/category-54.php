...
<div id="contentSingle">
    ...
    <div id="contentSingle_colEsquerda">
        <div id="contentSingle_colEsquerda_tituloCategoriaEicones-margemReleases">
            ...
            <h1 class="contentSingle_colEsquerda_tituloCategoria">Releases - Aut&oacute;dromo de Interlagos</h1>  
        </div>
