...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php if( is_home() ) { echo 'Ciclofaixa'; } else { ?><?php bloginfo('name') ?> - <?php bloginfo('description') ?><?php } ?></title>
            ...
            <div id="all">
                ...
                <div class="allMobile">
                    <nav class="menuMobile">
                        ...
                        <form style="z-index: 9999999999999;"role="search" method="get" id="searchform" action="<?php echo home_url('/'); ?>">
                            <input class="faixaHeader_busca_input" type="text" value="Buscar..." name ="s" maxlenght="20" onclick="this.value = ''"/>
                            <button class="faixaHeader_busca_btn" type="submit"></button>  
                        </form>
                        <ul id="menu" class="menuMobile_ul">
                            ...
                            <li class="menuMobile_ul_li">
                              ...
                              <li class="menuMobile_ul_li">
                                <a class="menuMobile_ul_a" href="<?php echo get_permalink($transporte); ?>">Bike no trem e metr&ocirc;</a>
                            </li>
                            <li class="menuMobile_ul_li">
                                <a class="menuMobile_ul_a" href="<?php echo get_permalink($porai); ?>">Por a&iacute;</a>
                            </li>
                        </ul>
                    </nav>
