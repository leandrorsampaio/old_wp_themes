    ...
    <div id="wrapper">
        <div id="tabs">
            <div id="tabs_container" class="mapaWrap_esq">    
                ...
                <div id="tabs-1">
                    <span class="mapaWrap_esq_title">Clique a zona que quer consultar no mapa ao lado</span>
            ...
            <ul class="mapaWrap_dir">
                <li class="mapaWrap_dir_item mapCE">
                    <a href="#tabs-2" title="" class="mapaWrap_dir_item_link">Centro</a>
                </li>
                <li class="mapaWrap_dir_item mapZN">
                    <a href="#tabs-3" title="" class="mapaWrap_dir_item_link">Zona Norte</a>
                </li>
                <li class="mapaWrap_dir_item mapZL">
                    <a href="#tabs-4" title="" class="mapaWrap_dir_item_link">Zona Leste</a>
                </li>
                <li class="mapaWrap_dir_item mapZO">
                    <a href="#tabs-5" title="" class="mapaWrap_dir_item_link">Zona Oeste</a>
                </li>
                <li class="mapaWrap_dir_item mapZS">
                    <a href="#tabs-6" title="" class="mapaWrap_dir_item_link">Zona Sul</a>
                </li>
