	...
	$.fn.jflatTimeline = function(options){
		...
		/**------------------ INSERT  YEAR MONTH BAR------------------**/
			...
			if(!selector.children('.month-year-bar').length){
				...
				selector.children('.month-year-bar').prepend('<div class="calendario_titulo">ATRA&Ccedil;&Otilde;ES IMPERD&Iacute;VEIS</div>')
		...
		/**------------------ INSERT DATES BAR------------------**/
			...
			if(!selector.children('.month-year-bar').length){
				selector.prepend('<div class = "month-year-bar"></div>')
				selector.children('.month-year-bar').prepend(+ String(current_year))
				selector.children('.month-year-bar').prepend('<div class = "month">' + String(month[current_month]))
			}
