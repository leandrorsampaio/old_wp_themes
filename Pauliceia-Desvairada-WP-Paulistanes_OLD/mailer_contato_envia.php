...
$objeto_email->SetFrom('leandrosampaio@spturis.com'); // EMAIL FROM
$objeto_email->IsHTML = TRUE;
$objeto_email->AddReplyTo('noreply@spturis.com', ' Favor não responder');

$objeto_email->AddAddress("leandrosampaio@spturis.com");
...
if ($objeto_email->Send()) {
    header('Location: http://spturis.com/sistemas/mailer_anhembi/mailer_contato_ok.php');
} else {
    header('Location: http://spturis.com/sistemas/mailer_anhembi/mailer_contato_not.php');
}
?>
